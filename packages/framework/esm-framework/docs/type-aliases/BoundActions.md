...
Defined in: [packages/framework/esm-react-utils/src/useStore.ts:11](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useStore.ts#L11)
