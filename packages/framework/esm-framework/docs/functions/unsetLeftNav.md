...
Defined in: [packages/framework/esm-extensions/src/left-nav.ts:49](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/left-nav.ts#L49)
