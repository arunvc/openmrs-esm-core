...
Defined in: [packages/framework/esm-context/src/context.ts:29](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-context/src/context.ts#L29)
