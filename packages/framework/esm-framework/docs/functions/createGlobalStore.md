...
Defined in: [packages/framework/esm-state/src/state.ts:31](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-state/src/state.ts#L31)
