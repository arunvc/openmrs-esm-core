...
Defined in: [packages/framework/esm-translations/src/index.ts:66](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-translations/src/index.ts#L66)
