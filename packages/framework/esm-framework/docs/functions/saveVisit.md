...
Defined in: [packages/framework/esm-emr-api/src/visit-utils.ts:81](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-emr-api/src/visit-utils.ts#L81)
