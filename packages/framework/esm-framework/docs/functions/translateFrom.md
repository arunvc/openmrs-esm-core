...
Defined in: [packages/framework/esm-translations/src/index.ts:40](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-translations/src/index.ts#L40)
