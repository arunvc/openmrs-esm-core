...
Defined in: [packages/framework/esm-extensions/src/left-nav.ts:40](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/left-nav.ts#L40)
