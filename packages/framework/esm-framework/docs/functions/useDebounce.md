...
Defined in: [packages/framework/esm-react-utils/src/useDebounce.ts:32](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useDebounce.ts#L32)
