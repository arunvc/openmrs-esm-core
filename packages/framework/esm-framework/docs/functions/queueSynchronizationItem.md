...
Defined in: [packages/framework/esm-offline/src/sync.ts:261](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L261)
