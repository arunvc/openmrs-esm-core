...
Defined in: [packages/framework/esm-config/src/validators/validator.ts:25](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-config/src/validators/validator.ts#L25)
