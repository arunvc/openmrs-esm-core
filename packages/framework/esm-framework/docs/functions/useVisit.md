...
Defined in: [packages/framework/esm-react-utils/src/useVisit.ts:42](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-react-utils/src/useVisit.ts#L42)
