...
Defined in: [packages/framework/esm-offline/src/mode.ts:45](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/mode.ts#L45)
