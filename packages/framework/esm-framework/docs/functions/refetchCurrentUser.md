...
Defined in: [packages/framework/esm-api/src/current-user.ts:163](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-api/src/current-user.ts#L163)
