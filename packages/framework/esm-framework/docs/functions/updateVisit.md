...
Defined in: [packages/framework/esm-emr-api/src/visit-utils.ts:92](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-emr-api/src/visit-utils.ts#L92)
