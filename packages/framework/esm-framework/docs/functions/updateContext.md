...
Defined in: [packages/framework/esm-context/src/context.ts:87](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-context/src/context.ts#L87)
