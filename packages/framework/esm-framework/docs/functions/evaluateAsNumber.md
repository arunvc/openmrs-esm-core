...
Defined in: [packages/framework/esm-expression-evaluator/src/evaluator.ts:206](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-expression-evaluator/src/evaluator.ts#L206)
