...
Defined in: [packages/framework/esm-offline/src/sync.ts:281](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L281)
