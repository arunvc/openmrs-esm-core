...
Defined in: [packages/framework/esm-navigation/src/history/history.ts:58](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-navigation/src/history/history.ts#L58)
