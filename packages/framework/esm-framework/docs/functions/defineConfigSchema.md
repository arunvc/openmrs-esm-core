...
Defined in: [packages/framework/esm-config/src/module-config/module-config.ts:177](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-config/src/module-config/module-config.ts#L177)
