...
Defined in: [packages/framework/esm-api/src/openmrs-fetch.ts:272](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-api/src/openmrs-fetch.ts#L272)
