...
Defined in: [packages/framework/esm-api/src/current-user.ts:244](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-api/src/current-user.ts#L244)
