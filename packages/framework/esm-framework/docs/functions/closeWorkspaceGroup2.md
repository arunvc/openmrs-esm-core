...
Defined in: [packages/framework/esm-styleguide/src/workspaces2/workspace2.ts:75](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-styleguide/src/workspaces2/workspace2.ts#L75)
