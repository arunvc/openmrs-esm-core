...
Defined in: [packages/framework/esm-offline/src/sync.ts:302](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-offline/src/sync.ts#L302)
