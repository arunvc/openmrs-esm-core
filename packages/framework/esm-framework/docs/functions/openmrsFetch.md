...
Defined in: [packages/framework/esm-api/src/openmrs-fetch.ts:83](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-api/src/openmrs-fetch.ts#L83)
