...
Defined in: [packages/framework/esm-context/src/context.ts:48](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-context/src/context.ts#L48)
