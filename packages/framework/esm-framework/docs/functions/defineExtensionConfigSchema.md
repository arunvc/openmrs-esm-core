...
Defined in: [packages/framework/esm-config/src/module-config/module-config.ts:253](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-config/src/module-config/module-config.ts#L253)
