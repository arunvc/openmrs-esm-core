...
Defined in: [packages/framework/esm-context/src/context.ts:63](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-context/src/context.ts#L63)
