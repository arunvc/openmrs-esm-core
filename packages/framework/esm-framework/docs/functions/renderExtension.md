...
Defined in: [packages/framework/esm-extensions/src/render.ts:18](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/render.ts#L18)
