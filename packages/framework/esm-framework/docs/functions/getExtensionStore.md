...
Defined in: [packages/framework/esm-extensions/src/store.ts:131](https://github.com/arunvc/openmrs-esm-core/blob/main/packages/framework/esm-extensions/src/store.ts#L131)
